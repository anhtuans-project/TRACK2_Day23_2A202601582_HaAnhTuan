...
|---|---|---|
| 2026-08-25T17:31:41 | outage bắt đầu | `chaos/chaos-events.jsonl:18` |
| 2026-08-25T17:31:43 | user đầu tiên bị ảnh hưởng | `reports/drill-2-withdr.jsonl:32` |
| 2026-08-25T17:31:58 | health check alert | `reports/health-events.jsonl:8` |
| 2026-08-25T17:32:07 | operator confirm cutover | `reports/runbook-run.jsonl:last` |
| 2026-08-25T17:32:29 | resolved (request đầu tiên OK từ region phụ) | `reports/drill-2-withdr.jsonl:43` |

## 2. RTO/RPO đo được vs mục tiêu — gap ở bước nào?

- RTO mục tiêu: 300s · đo được: `28.2s` · gap: `-271.8s`
